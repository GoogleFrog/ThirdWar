...
local moduleDefs = {
	...
	},
	{
		...
		description = "Autorepair - Commander self-repairs at +15 hp/s. Reduces Health by " .. 100*HP_MULT .. ". Limit: 8",
	...
	},
	{
		...
		description = "High Density Plating - Provides " .. 2000*HP_MULT .. " health but reduces movement by 10%. " .. 
	...
	},
	{
		...
		description = "Damage Booster - Increases damage by 25% but reduces speed by 5%.  Limit: 8",
	...
	},
	{
		...
		description = "Advanced Targeting System - Increases range by 25% but reduces speed by 5%. Limit: 8",
