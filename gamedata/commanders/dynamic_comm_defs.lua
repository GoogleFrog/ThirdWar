...
local moduleDefs = {
	...
	},
	{
		...
		description = "High Density Plating - Provides " .. 1500*HP_MULT .. " health but reduces movement by 10%. " .. 
		...
		slotType = "module",
		applicationFunction = function (modules, sharedData)
			sharedData.healthBonus = (sharedData.healthBonus or 0) + 1500*HP_MULT
	...
	},
	{
		...
		description = "Damage Booster - Increases damage by 20%, increased weapon weight reduces speed by 5%.  Limit: 8",
		...
		applicationFunction = function (modules, sharedData)
			...
			sharedData.speedMult = (sharedData.speedMult or 1) - 0.05
		end
	},
	{
		name = "module_high_power_servos",
		humanName = "High Power Servos",
		description = "High Power Servos - Increases speed by 25%. Limit: 8",
		...
		slotType = "module",
		applicationFunction = function (modules, sharedData)
			sharedData.speedMult = (sharedData.speedMult or 1) + 0.25
		end
	},
	{
		name = "module_adv_targeting",
		humanName = "Adv. Targeting System",
		description = "Advanced Targeting System - Increases range by 20%, increased weapon weight reduces speed by 5%. Limit: 8",
		...
		slotType = "module",
		applicationFunction = function (modules, sharedData)
			sharedData.rangeMult = (sharedData.rangeMult or 1) + 0.20
			sharedData.speedMult = (sharedData.speedMult or 1) - 0.02
		end
	},
	{
		name = "module_adv_nano",
		humanName = "CarRepairer's Nanolathe",
		description = "CarRepairer's Nanolathe - Increases build power by 10. Limit: 8",
