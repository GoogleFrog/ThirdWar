...
-- commanders
  ...
  --------------------------------------------------------------------------------
  rifleman = {
    bitmap='icons/rifleman.dds',
    size=2.0,
  },
  abrams = {
    bitmap='icons/abrams.dds',
    size=2.0,
  },  
  humvee = {
    bitmap='icons/humvee.dds',
    size=2.0,
  },
  planescout = {
    bitmap='icons/e3.dds',
  ...
  stealthfighter = {
    bitmap='icons/f35.dds',
    size=2,
  },
  planefighter = {
    bitmap='icons/f15.dds',
    size=2,
  },  
  planeheavyfighter = {
    bitmap='icons/f16.dds',
    size=2,
  },
  f18 = {
    bitmap='icons/f18.dds',
    size=2,
  },  
  planebomber = {
    bitmap='icons/a10.dds',
    size=2,
  },
  a10 = {
    bitmap='icons/a10.dds',
