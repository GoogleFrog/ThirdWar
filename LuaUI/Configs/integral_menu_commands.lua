...
local units = {
	factorycloak = {
		...
		cloakraid = {order = 2, row = 1, col = 2},
		cloakriot = {order = 3, row = 1, col = 3},
		cloakskirm = {order = 4, row = 1, col = 4},
		cloakarty = {order = 5, row = 1, col = 5},
		howitzer = {order = 6, row = 1, col = 6},
		
						
		cloakaa = {order = 7, row = 2, col = 2},
		cloakassault = {order = 8, row = 2, col = 3},		
		cloaksnipe = {order = 9, row = 2, col = 4},
		cloakheavyraid = {order = 10, row = 2, col = 5},
...
--		cloakjammer = UTILITY,
	...
	factoryveh = {
		vehcon = {order = 1, row = 1, col = 1},
		
		--tankraid = {order = 2, row = 1, col = 2},
		truck = {order = 2, row = 1, col = 2},
		tankheavyraid = {order = 3, row = 1, col = 3},		
		--vehscout = WEIRD_RAIDER,
		vehraid = {order = 4, row = 1, col = 4},
		vehriot = {order = 5, row = 1, col = 5},
		vehaa = {order = 6, row = 1, col = 6},
		
		vehsupport = {order = 7, row = 2, col = 1},
		veharty = {order = 8, row = 2, col = 2},
		vehcapture = {order = 9, row = 2, col = 3},
				
		striderarty = {order = 10, row = 2, col = 4},
		vehheavyarty = {order = 11, row = 2, col = 5},
		topol = {order = 12, row = 2, col = 6},
		
	},
	factorytank = {
		tankcon =  {order = 1, row = 1, col = 1},
		vehassault = {order = 2, row = 1, col = 2},
		tankassault = {order = 3, row = 1, col = 3},
		tankheavyassault = {order = 4, row = 1, col = 4},
		
		tankaa = {order = 5, row = 2, col = 1},
		tankriot = {order = 6, row = 2, col = 2},		
		
		tankarty = {order = 7, row = 2, col = 3},
		tankheavyarty = {order = 8, row = 2, col = 4},
	...
	factoryplane = {
		planecon = {order = 1, row = 1, col = 1},		

		planescout = {order = 2, row = 1, col = 2},				
		
		gunshipheavyskirm = {order = 4, row = 1, col = 4},
		gunshiptrans = {order = 5, row = 1, col = 5},
		gunshipheavytrans = {order = 6, row = 1, col = 6},

		planeheavyfighter = {order = 7, row = 2, col = 1},				
		planefighter = {order = 8, row = 2, col = 2},		
		bomberdisarm = {order = 9, row = 2, col = 3},
		
--		planebomber = {order = 9, row = 2, col = 3},		
		bomberprec = {order = 10, row = 2, col = 4},
		bomberriot = {order = 11, row = 2, col = 5},
		bomberheavy = {order = 12, row = 2, col = 6},
		
	},	
	factoryship = {
		shipcon = {order = 1, row = 1, col = 1},	
		shiptorpraider = {order = 2, row = 1, col = 2},
		shipskirm = {order = 3, row = 1, col = 3},
		shipriot = {order = 4, row = 1, col = 4},		
		shiparty = {order = 5, row = 1, col = 5},
		shipaa = {order = 6, row = 1, col = 6},
		--shipscout = WEIRD_RAIDER,
		
		shiptransport = {order = 7, row = 2, col = 1},
		shipassault = {order = 8, row = 2, col = 2},		
		subraider = {order = 9, row = 2, col = 3},		
		subtacmissile = {order = 10, row = 2, col = 4},
		shipheavyarty = {order = 11, row = 2, col = 5},
		shipcarrier = {order = 12, row = 2, col = 6},
...
local factories = {
	...
	factoryveh =      {order = 2, row = 1, col = 2}, --order = 3, row = 1, col = 3
	factorytank =     {order = 3, row = 1, col = 3},
	--factorygunship =  {order = 4, row = 2, col = 1},
	factoryplane =    {order = 5, row = 2, col = 1},
	factoryship =    {order = 6, row = 3, col = 1},
	--striderhub =     {order = 7, row = 3, col = 2},		
...
local econ = {
	...
	energypylon =   {order = 7, row = 3, col = 1},
	staticstorage =   {order = 8, row = 3, col = 2},
	house =   {order = 9, row = 3, col = 3},
	staticcon =  {order = 10, row = 3, col = 4},
	staticrearm =    {order = 11, row = 3, col = 5},
}

local defense = {
	
	wall 			=  {order = 1, row = 1, col = 1},
	turretmissile 	=	{order = 2, row = 1, col = 2},	
	turretaalaser 	=  {order = 3, row = 1, col = 3},
--	turretgauss 	=	{order = 3, row = 1, col = 3},
--	turretheavy		=	{order = 4, row = 1, col = 4},	
--	turretemp 		=	{order = 4, row = 1, col = 4},
	--turretlaser =   {order = 2, row = 1, col = 1},
	--turretheavylaser =   {order = 5, row = 1, col = 6},

	
	
	turretaaflak 	=  {order = 5, row = 2, col = 1},	
	turretaaclose 	=  {order = 6, row = 2, col = 2},
	turretriot		=	{order = 7, row = 2, col = 3},
--	turretaafar 	=  {order = 8, row = 2, col = 4},
	turretaaheavy 	=  {order = 8, row = 2, col = 4},

	turrettorp		=	{order = 9, row = 3, col = 1},	
...
local overrides = {
	...
	[CMD_FIND_PAD] = {texture = imageDir .. 'Bold/rearm.png'},
