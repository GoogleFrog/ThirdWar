...
--    {class='GroundFlash', options=groundFlashOrange},
	...
	vehraid = {
		{class='Ribbon', options={color={.5,.4,.3,0.66}, width=8, length=32, piece="lwheel2", onActive=false, noIconDraw = true, quality = 2}},
		{class='Ribbon', options={color={.5,.4,.3,0.66}, width=8, length=32, piece="rwheel2", onActive=false, noIconDraw = true, quality = 2}},
	},	
...
--[[	
	...
	bomberdisarm = {	
		--F35
		{class='AirJet', options={color={0.6,0.1,0.0}, width=3.5, length=25, piece="nozzle", texture2=":c:bitmaps/gpl/lups/jet2.bmp", onActive=true, noIconDraw = true}},
...
--[[	
	...
	planebomber = {	
		--old decoydrone
		{class='AirJet', options={color={0.7,0.3,0.1}, width=3.5, length=20, piece="Jet1", onActive=true, noIconDraw = true}},
		{class='AirJet', options={color={0.7,0.3,0.1}, width=3.5, length=20, piece="Jet2", onActive=true, noIconDraw = true}},
	...
	bomberheavy = {
		--B2 Stealth Bomber
		{class='AirJet', options={color={0.6,0.1,0.0}, width=3.5, length=25, piece="nozzle1", texture2=":c:bitmaps/gpl/lups/jet2.bmp", onActive=true, noIconDraw = true}},
		{class='AirJet', options={color={0.6,0.1,0.0}, width=3.5, length=25, piece="nozzle2", texture2=":c:bitmaps/gpl/lups/jet2.bmp", onActive=true, noIconDraw = true}},
		{class='Ribbon', options={width=1, length=15, piece="wingtip1", noIconDraw = true}},
		{class='Ribbon', options={width=1, length=15, piece="wingtip2", noIconDraw = true}},	
	...
	bomberprec = {
		--A10
		{class='AirJet', options={color={0.7,0.3,0.1}, width=4, length=30, piece="nozzle1", texture2=":c:bitmaps/gpl/lups/jet2.bmp", onActive=true, noIconDraw = true}},
		{class='AirJet', options={color={0.7,0.3,0.1}, width=4, length=30, piece="nozzle2", texture2=":c:bitmaps/gpl/lups/jet2.bmp", onActive=true, noIconDraw = true}},
	...
	bomberriot = {
		{class='AirJet', options={color={0.7,0.3,0.1}, width=5, length=40, piece="exhaustl", onActive=true, noIconDraw = true}},
		{class='AirJet', options={color={0.7,0.3,0.1}, width=5, length=40, piece="exhaustr", onActive=true, noIconDraw = true}},
		{class='Ribbon', options={width=1, piece="wingtipl", noIconDraw = true}},
		{class='Ribbon', options={width=1, piece="wingtipr", noIconDraw = true}},
	...
	planeheavyfighter = {
		...
		--{class='AirJet', options={color={0.6,0.1,0.0}, width=3.5, length=25, piece="nozzle1", texture2=":c:bitmaps/gpl/lups/jet2.bmp", onActive=true, noIconDraw = true}},
		--{class='AirJet', options={color={0.6,0.1,0.0}, width=3.5, length=25, piece="nozzle2", texture2=":c:bitmaps/gpl/lups/jet2.bmp", onActive=true, noIconDraw = true}},
		{class='Ribbon', options={width=1, length=25, piece="wingtipr", noIconDraw = true}},
		{class='Ribbon', options={width=1, length=25, piece="wingtipl", noIconDraw = true}},
	},	
	planefighter = {
		-- jets done in gadget
	...
	planescout = {
		{class='AirJet', options={color={0.6,0.1,0.0}, width=3.5, length=25, piece="nozzle1", texture2=":c:bitmaps/gpl/lups/jet2.bmp", onActive=true, noIconDraw = true}},
		{class='AirJet', options={color={0.6,0.1,0.0}, width=3.5, length=25, piece="nozzle2", texture2=":c:bitmaps/gpl/lups/jet2.bmp", onActive=true, noIconDraw = true}},
		{class='AirJet', options={color={0.6,0.1,0.0}, width=3.5, length=25, piece="nozzle3", texture2=":c:bitmaps/gpl/lups/jet2.bmp", onActive=true, noIconDraw = true}},
		{class='AirJet', options={color={0.6,0.1,0.0}, width=3.5, length=25, piece="nozzle4", texture2=":c:bitmaps/gpl/lups/jet2.bmp", onActive=true, noIconDraw = true}},		
		{class='Ribbon', options={width=1, length=25, piece="wingtipl", noIconDraw = true}},
		{class='Ribbon', options={width=1, length=25, piece="wingtipr", noIconDraw = true}},
		--{class='StaticParticles', options=MergeTable(blinkyLightRed, {piece="wingtipr"}) },
		--{class='StaticParticles', options=MergeTable(blinkyLightGreen, {piece="wingtipl"}) },		
