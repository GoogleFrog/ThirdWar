...
do
	...
	function DrawUnitInfos(unitID,unitDefID)
		...
		--// HEALTH
		if (maxHealth > 400) and (health) and ((drawFullHealthBars)or(hp<1)) and ((build==1)or(hp<0.66 and (build>hp+0.01 or hp>build+0.01))or(drawFullHealthBars)) then
